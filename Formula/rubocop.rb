class Rubocop < Formula
  ...
  depends_on "gem-parser" => :install
  depends_on "gem-powerpack" => :install
  depends_on "gem-rainbow" => :install
  depends_on "gem-ruby-progressbar" => :install
  depends_on "gem-unicode-display-width" => :install
